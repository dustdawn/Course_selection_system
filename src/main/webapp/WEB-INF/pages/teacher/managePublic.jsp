      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<%=basePath%>/teacher/managePublic"><i class="fa fa-circle-o"></i> 公选课</a></li>
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <div class="col">
                ...
                <%--<label class="form-inline" for="searchByNo" style="padding-left: 40px"/>课程编号查询：
                ...
                <label class="form-inline" for="searchByName" style="padding-left: 40px"/>课程名称查询：
              ...
              <table id="courseList" class="table table-bordered table-hover">
                ...
                <c:forEach var="item" items="${courseList}" varStatus="staturs">
                  <tr>
                    ...
                    <td>${item.credit}</td>
                    <td>${item.total}</td>
                    <td><a href="<%=basePath%>/teacher/courseEdit?cno=${item.cno}">编辑</a></td>
                    <td><a href="#" data-toggle="modal" data-target="#deleteConfirm">删除</a>
                      <a href="<%=basePath%>/teacher/courseDelete?cno=${item.cno}" id="yes"></a>
                    </td>
