      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<%=basePath%>/pages/student/selectPublic"><i class="fa fa-circle-o"></i> 公选课录入</a></li>
            <li><a href="<%=basePath%>/pages/student/selectElective"><i class="fa fa-circle-o"></i> 选修课录入</a></li>
          </ul>
        </li>
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<%=basePath%>/pages/student/info"><i class="fa fa-circle-o"></i> 个人信息</a></li>
