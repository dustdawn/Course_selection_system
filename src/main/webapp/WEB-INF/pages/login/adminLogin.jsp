...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg">管理员 登录 / LOGIN</p>

    <form action="<%=basePath%>/pages/pace" method="post">
      <div class="form-group has-feedback">
        <input type="user" class="form-control" placeholder="请输入用户名">
    ...
    <div class="social-auth-links text-left">
      <a href="#">忘记密码</a><br>
      <a href="<%=basePath%>/pages/login/studentLogin" class="text-center">学生登录</a>
      <a href="<%=basePath%>/pages/login/adminLogin" class="text-center">管理员登录</a>
